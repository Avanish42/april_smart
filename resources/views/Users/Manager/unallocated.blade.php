                                                ...
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table class="table mb-0 font-10 light-gray ">
                                                            ...
                                                            <tr class="head">
                                                                <td colspan="11">Unallocated Bills</td>
                                                            </tr>
...
{{--                                                            {{dd($unallocatedBilldata)}}--}}
                                                            @if(isset($unallocatedBilldata) && $unallocatedBilldata->count() > 0)
                                                                @foreach($unallocatedBilldata as $key_supply => $value_supply)
                                                                    <tr @php
                                                                        if($key_supply%2 != 0){
                                                                        echo 'class="odd"';
                                                                        }
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table mb-0 font-10 light-gray ">
                                                            ...
                                                            <tr class="head">
                                                                <td colspan="11">Unassigned  Bills</td>
                                                            </tr>
                                                            ...
                                                            {{--                                                            {{dd($unallocatedBilldata)}}--}}
                                                            @if(isset($unassignedBills) && $unassignedBills->count() > 0)
                                                                @foreach($unassignedBills as $key_supply => $value_supply)
                                                                    <tr @php
                                                                        if($key_supply%2 != 0){
                                                                        echo 'class="odd"';
                                                                        }
