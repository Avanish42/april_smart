...
@section('main-content')
    ...
    <div ng-controller="salesReturn as vm" class="app-content content container-fluid">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">Sales Return</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <section id="basic-form-layouts">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form">Sales Return</h4>
                                ...
                                <div class="card-text">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                                    ...
                                                    <table class="table  light-gray  m-b-10 table-bordered" style="width:80%; margin:auto;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3">Dated<br>
                                                                <strong>
                                                                    {{date('d-M-Y',strtotime($salesreturntempbill->created_at))}}
                                                                </strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">Retailer Name</td>
                                                            <td colspan="3">
                                                                <input type="text" class="no-border back-set" ng-disabled="true" ng-trim="false" typeahead-on-select="vm.retailerchange()" ng-blur="vm.retailerchange()" ng-model="vm.billretailer" empty-typeahead uib-typeahead="item as item.retailer_name for item in vm.retailers | filter:$viewValue:stateComparator" >
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr ng-repeat="(key,bill) in vm.bills">
                                                            ...
                                                            <form name="billform" novalidate="" form-on-change="change()" >
                                                                ...
                                                                <td style="vertical-align:text-top; text-align:left;">
                                                                    ...
                                                                    <input type="text" class="no-border back-set" ng-trim="false" ng-disabled="bill.disabledinputtext" ng-blur="formChangeEPro(bill,key)" ng-model="bill.products" empty-typeahead uib-typeahead="item as item.item_name for item in vm.states | filter:$viewValue:stateComparator" >
                                                                </td>
                                                                ...
                                                                <td style="vertical-align:text-top; text-align:right;">
                                                                    <input type="number" name="quantity_tempbill" ng-disabled="bill.disabledinputtext" ng-blur="formChangeE(bill,key)" ng-model="bill.quantity" style="width: 70px;" class="back-set no-border mrptempbill">
                                                                </td>
                                                                <td style="vertical-align:text-top; text-align:right;">
                                                                    <select class="back-set unititemtypetempbill no-border" ng-disabled="bill.disabledinputtext" ng-change="formChangeE(bill,key)" ng-model="bill.units"  ng-options="item for item in vm.piecesBox" name="unit_item_type_tempbill">

                                                                    </select>
                                                                </td>
                                                                <td style="vertical-align:text-top; text-align:right;"><input type="number" name="rate_tempbill" ng-disabled="bill.disabledinputtext" ng-blur="formChangeE(bill,key)" ng-model="bill.rate" style="width: 70px;" class="back-set no-border ratetempbill"></td>
                                                                <td style="vertical-align:text-top; text-align:right;">
                                                                    <select class="back-set rateitemtypetempbill no-border" ng-disabled="bill.disabledinputtext" ng-change="formChangeE(bill,key)" ng-model="bill.per" ng-options="item for item in vm.piecesBox" class="no-border" name="per_item_type_tempbill">
                                            ...
                                            <br>
                                            <div class="col-sm-12 clearfix">
                                                <h4 class="card-title" id="basic-layout-form">Add sales return here</h4>
                                            ...
                                            <div class="col-sm-12 clearfix">
                                                <div class="table-responsive">
                                                    <table class="table  light-gray  m-b-10 table-bordered" style="width:80%; margin:auto;">
                                                        ...
                                                        <tbody>
                                                        <tr ng-repeat="(key,bill) in vm.salesreturn">
                                                            ...
                                                            <form name="billform" novalidate="" form-on-change="change()" >
                                                                ...
                                                                <td style="vertical-align:text-top; text-align:left;">
                                                                    ...
                                                                    {{--</select>--}}{{--typeahead-on-select="vm.productSelect($item, $model, $label)"--}}
                                                                ...
                                                                <td style="vertical-align:text-top; text-align:right;">
                                                                    <select class="back-set unititemtypetempbill no-border"  ng-change="formChangeE(bill,key)" ng-model="bill.units" disabled="disabled"  ng-options="item for item in vm.piecesBox" name="unit_item_type_tempbill">

                                                                    </select>
                                                                </td>
                                                                <td style="vertical-align:text-top; text-align:right;"><input type="number" name="rate_tempbill" ng-blur="formChangeE(bill,key)" disabled="disabled" ng-model="bill.rate" style="width: 70px;" class="back-set no-border ratetempbill"></td>
                                                                <td style="vertical-align:text-top; text-align:right;">
                                                                    <select class="back-set rateitemtypetempbill no-border" ng-change="formChangeE(bill,key)" disabled="disabled" ng-model="bill.per" ng-options="item for item in vm.piecesBox" class="no-border" name="per_item_type_tempbill">
                                                        ...
                                                        <tr class="tblfooter">
                                                            ...
                                                            <td>-</td>
                                                            <td>
                                                                @{{vm.totalAmount}} - @{{vm.salesReturntotalAmount}} = @{{vm.returntotalamount}} &#x20b9/-</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
