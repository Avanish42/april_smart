                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="name" id="companyName" class="form-control" placeholder="Enter your Company Name">
                                                @extends('app')
                                                @section('pagetitle')
                                                    Add Employee
                                                @endsection
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="body">
                                                                            <form method="POST" enctype="multipart/form-data"  id="add_attribute" action="{{ url('/Relation/updatePermissionRelation')  }}">
                                                                                {{csrf_field()}}
                                                                                ...
                                                                                <div class="row clearfix">
                                                                                    ...
                                                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                                                        <div class="form-group">
                                                                                            <div class="form-line">
                                                                                                <input type="text" name="id" value="{{$role[0]['id']}}" hidden>
                                                                                                <h5>{{"Role Name  :: ". $role[0]['display_name']   }}</h5>
                                                                                                {{--                                               {{print_r($employee[0]['roles'])}}--}}

                                                                                                <div>
                                                                                                    @if($role[0]['perms'])
                                                                                                        <ul>
                                                                                                            @foreach($role[0]['perms'] as $k=>$v)
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <div class="demo-checkbox">
                                                                                            @foreach($allpermission as $k=>$v)
                                                                                                ...
                                                                                                <input type="checkbox" id="md_checkbox_21{{$k}}" class="filled-in chk-col-blue" name="addperm[]" value={{$v['name'] }}  >
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <div class="demo-checkbox">
                                                                                            @foreach($role[0]['perms'] as $k=>$v)
                                                                                                ...
                                                                                                <input type="checkbox" id="md_checkbox_21{{$k+20}}" class="filled-in chk-col-red" name="removeperm[]" value={{$v['name'] }}  >
